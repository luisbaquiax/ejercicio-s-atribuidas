...
public class Parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short _production_table[][] = 
    ...
    "\005\000\002\004\003\000\002\003\004\000\002\003\003" +
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\013\000\006\005\005\006\006\001\002\000\006\002" +
    "\ufffe\004\ufffe\001\002\000\012\002\ufffb\004\ufffb\005\ufffb" +
    "\006\ufffb\001\002\000\012\002\ufffa\004\ufffa\005\ufffa\006" +
    "\ufffa\001\002\000\012\002\ufffc\004\ufffc\005\005\006\006" +
    "\001\002\000\004\002\014\001\002\000\006\002\000\004" +
    "\012\001\002\000\006\005\005\006\006\001\002\000\006" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\013\000\012\002\007\003\003\004\010\005\006\001" +
    "\001\000\002\001\001\000\002\001\001\000\002\001\001" +
    "\000\006\003\014\005\006\001\001\000\002\001\001\000" +
    "\002\001\001\000\006\003\012\005\006\001\001\000\002" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
		...
		RESULT = start_val;
          ...
          case 2: // c ::= c COMA b 
            {
              Reduccion RESULT =null;
		int aleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).left;
		int aright = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).right;
		Reduccion a = (Reduccion)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-2)).value;
		int bleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).left;
		int bright = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).right;
		Reduccion b = (Reduccion)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 System.out.print(b.getDecimal() + ","); 
		...
		Reduccion a = (Reduccion)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 System.out.print(a.getDecimal() + ","); 
		...
		Reduccion a = (Reduccion)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		int bleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).left;
		int bright = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).right;
		Reduccion b = (Reduccion)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		...
		Object a = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = new Reduccion(Integer.parseInt(a.toString()),0,0); 
